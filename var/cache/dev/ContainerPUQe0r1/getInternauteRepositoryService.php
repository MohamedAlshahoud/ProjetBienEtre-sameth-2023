...
class getInternauteRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InternauteRepository.php';

        return $container->privates['App\\Repository\\InternauteRepository'] = new \App\Repository\InternauteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
