...
class getCodePostalRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CodePostalRepository.php';

        return $container->privates['App\\Repository\\CodePostalRepository'] = new \App\Repository\CodePostalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
